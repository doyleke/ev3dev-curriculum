...
Much like we did in doyleke of the motors unit, later we will show you different (better) ways to use buttons.

Authors: David Fisher and Rachel, Abbie, Kayleigh.
...
def main():
    ...
    while True:
        ...
        if btn.down:
            print('dowwwwwwnnnnnn',led_colors[current_color_index])
