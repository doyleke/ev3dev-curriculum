...
Authors: David Fisher and Abbie Peterson.
...
def main():
    ...
    my_name = "petersa"  # Used to set the topic that you are *subscribed to*
    # listen to
    team_member_name = "doyleke"  # Used to set the topic that you will
    # *publish to*
